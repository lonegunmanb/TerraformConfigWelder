...
locals {
  azurerm_linux_virtual_machine_scale_set_gallery_applications_configuration_reference_blob_uri = azurerm_linux_virtual_machine_scale_set.example[0].gallery_application[0].configuration_blob_uri
  azurerm_linux_virtual_machine_scale_set_gallery_applications_package_reference_id             = azurerm_linux_virtual_machine_scale_set.example[0].gallery_application[0].version_id
  ...
  azurerm_linux_virtual_machine_scale_set_terminate_notification_enabled                        = azurerm_linux_virtual_machine_scale_set.example[0].termination_notification[0].enabled
  azurerm_linux_virtual_machine_scale_set_terminate_notification_timeout                        = azurerm_linux_virtual_machine_scale_set.example[0].termination_notification[0].timeout
}