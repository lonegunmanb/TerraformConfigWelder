...
resource "azurerm_subnet" "example" {
  ...
  private_endpoint_network_policies             = (var.azurerm_subnet_enforce_private_link_endpoint_network_policies != null || var.azurerm_subnet_private_endpoint_network_policies_enabled != null || false) ? ((false) ? (null) : ((var.azurerm_subnet_private_endpoint_network_policies_enabled != null) ? (var.azurerm_subnet_private_endpoint_network_policies_enabled ? ("Enabled") : ("Disabled")) : (var.azurerm_subnet_enforce_private_link_endpoint_network_policies ? ("Disabled") : ("Enabled")))) : ("Enabled")
  private_link_service_network_policies_enabled = (var.azurerm_subnet_enforce_private_link_service_network_policies != null) ? (!var.azurerm_subnet_enforce_private_link_service_network_policies) : (true)
